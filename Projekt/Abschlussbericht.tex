...
\end{IEEEkeywords}
\section{Einleitung}
Netzwerke bilden heute die Basis für moderne IT-Infrastrukturen und sind aus Sicht der Unternehmen nicht mehr wegzudenken. Sie ermöglichen den gemeinsamen Zugriff auf Ressourcen und bieten Kommunikationsmöglichkeiten zwischen Mitarbeitern, Abteilungen und verschiedenen Standorten \cite{schreiner2023computernetzwerke}. Ein leistungsfähiges und sicheres Netzwerk ist daher essenziell für den geschützten und stabilen Betrieb unternehmerischer Prozesse. 
Netzwerke werden in der Regel auf Grundlage von Sicherheitsmodellen konzipiert. Traditionelle Sicherheitsmodelle basieren dabei häufig auf dem sogenannten Perimeter-Schutz. Dabei wird davon ausgegangen, dass das interne Netzwerk vertrauenswürdig ist und nur externe Zugriffe besonders abgesichert werden müssen. Der Schutz konzentriert sich daher hauptsächlich auf die externen Grenzen des Netzwerkes, während dem internen Netzwerk ein gewisses Maß an Vertrauen entgegengebracht wird \cite{cloudflare2025castle}.
Dieses Modell stößt jedoch in Zeiten der wachsenden Bedeutung von Cloud-Diensten, mobilen Arbeitsplätzen und hybriden IT-Infrastrukturen immer mehr an seine Grenzen. Eine klare Trennung zwischen internen und externen Netzwerken ist in modernen Unternehmen oftmals nicht mehr gegeben. Angriffe erfolgen häufig nicht mehr von außen, sondern durch kompromittierte Geräte im internen Unternehmensnetzwerk. Vor diesem Hintergrund gewinnt das Zero Trust Modell immer mehr an Bedeutung.\\
